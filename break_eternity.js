...
function formatTime(s) {
 return formatWhole(Math.floor(s / 31536000)).toString().padStart(4,"0")+"·"+formatWhole(Math.floor(s / 604800) % 52 ).toString().padStart(2,"0")+"·"+formatWhole(Math.floor(s / 86400) % 7)+"·"+formatWhole(Math.floor(s / 3600) % 24).toString().padStart(2,"0")+"·"+formatWhole(Math.floor(s / 60) % 60).toString().padStart(2,"0")+"·"+Math.floor(s % 60).toString().padStart(2,"0")
}
/*
function formatTime(s) {
